...
erreur_terrain initialise_environnement(Environnement *envt,
  ...
  //Automate transition
  envt->observateur = initialise_automate();
...
resultat_deplacement avancer_envt(Environnement *envt) {
  ...
  //Automate transition
  envt->observateur=transition(envt->observateur,A);
...
void gauche_envt(Environnement *envt) { 
  envt->observateur=transition(envt->observateur,G);
  tourner_a_gauche(&(envt->r)); 
  }

/* Tourner le robot à droite */
void droite_envt(Environnement *envt) {
  envt->observateur=transition(envt->observateur,D);
...
int mesure_envt(Environnement *envt, int d) {
  ...
  //Automate transition
  envt->observateur=transition(envt->observateur,M);
